...
if(username==="Husky") {
    ...
    document.write("<img src=\"Images/BMW.bmp\" alt=\"Husky-webdev\'s logo\" height=\'300px\' width=\'300px\'> ");

}
else if (username==="Husky-webdev") {
    document.write("<h1>Hello " + username + " You won a " + car[1] + "!</h1>");
    document.write("<img src=\"Images/sabb.bmp\" alt=\"Husky-webdev\'s logo\" height=\'200px\' width=\'200px\'> ");

}

else if (username==="Preston") {
    document.write("<h1>Hello " + username + " You won a " + car[2] + "!</h1>");
    document.write("<img src=\"Images/maruti%20.bmp\" alt=\"Husky-webdev\'s logo\" height=\'200px\' width=\'200px\'> ");
